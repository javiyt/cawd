package com.victormartin.projectcawd.domain.executor.impl;
...
public class ThreadExecutor implements Executor {
    ...
    /**
     * Returns a singleton instance of this executor. If the executor is not initialized then it initializes it and
     * returns
     * the instance.
     */
